document.addEventListener('DOMContentLoaded', () => {
  ...
  const botKnowledge = [
    // --- ADMISSION STATUS & ERRORS ---
    {
      ...
      response:
        '<strong>Regarding failed status:</strong><br>' +
    ...
    },
    {
      ...
      response:
        'To check your status:<br>1. Log in to your account.<br>2. Look at the <strong>Status Bar</strong> on your dashboard.<br>' +
    ...
    // --- TUITION & FEES ---
    {
      ...
      response:
        '<strong>Good news!</strong><br>TUP is a state university covered by the <em>Universal Access to Quality Tertiary Education Act</em>.<br><br>' +
    ...
    // --- EXAM DETAILS ---
    {
      ...
      response:
        '<strong>Entrance Exam Info:</strong><br>' +
    ...
    // --- REQUIREMENTS ---
    {
      ...
      response:
        '<strong>Freshmen Requirements:</strong><br>' +
    ...
    // --- GENERAL INFO ---
    {
      ...
      response:
        'TUP is located at <strong>Ayala Blvd., Ermita, Manila</strong>.<br>Office hours are typically 8:00 AM to 5:00 PM, Monday to Friday.',
    },
    {
      keywords: ['hello', 'hi', 'hey', 'good morning'],
      response:
        'Hello! I am the TUP Admissions Bot. Ask me about courses, tuition, or your application status!',
    },
  ];

  const defaultResponse =
    "I'm not sure about that. Try asking about 'courses offered', 'tuition fee', or 'exam schedule'.";
